...
Proof.
  intros [] [].
- reflexivity.
- simpl. intros h. destruct h . reflexivity.
- simpl. intros h. destruct h . reflexivity.
- reflexivity.
Qed.
...
Example test_add1_bin0 : bin_to_nat Z = O.
Proof. simpl. reflexivity. Qed.
Example test_add1_bin1 : bin_to_nat( B Z) = 1 .
Proof. simpl. reflexivity. Qed.
