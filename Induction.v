...
Theorem plus_n_00 : forall n:nat,
n + 0 = n.
Proof.
...
- simpl. assert (H: forall x y, x+x*y=x* S y).
{ intros x y.
induction x.
- simpl. reflexivity.
- simpl. rewrite <- IHx. simpl. rewrite plus_swap. simpl. reflexivity.
}
...
- simpl. induction p. simpl. reflexivity. simpl. rewrite IHp. reflexivity.
simpl. 
Abort.
...
intros [].
- simpl. reflexivity.
- simpl. rewrite plus_n_00. reflexivity. Qed.
...
induction n. 
- simpl. reflexivity.
- simpl. rewrite IHn. rewrite plus_assoc. rewrite <- plus_n_Sm. simpl. rewrite plus_assoc. simpl. reflexivity.
Qed.         
...
induction n.
- simpl. reflexivity.
- simpl. assert (H: forall b, bin_to_nat (incr b) = 1+( bin_to_nat b)).
{ simpl. intros b. induction b.
- simpl. reflexivity.
- simpl. reflexivity.
- simpl. rewrite IHb. rewrite plus_n_Sm. simpl. reflexivity.
}
simpl. rewrite H. rewrite IHn. simpl. reflexivity.
Qed. 
...
induction n.
- simpl. reflexivity.
- simpl. rewrite plus_n_00. induction n.
{
- simpl. Abort.
(** in this case there is a borblem cause :
z = az    but
bin_to_nat z + bin_to_nat z = z **)
